...
public class Server {
    ...
    private final Map<Integer, RemoteView> remoteViewMap; //player id - remote view
    private final Map<Integer, SocketClientManager> idSocketMap; //player id - socket
    private final Map<SocketClientManager, Integer> socketIdMap; //socket - player id
    private final Map<Integer, Controller> playerControllerMap; //player id - associated controller
    private final Map<String, Controller> controllersMap; //controller name - controller
    private final List<Player> allPlayersList;
    private final List<Player> watchingLobbiesPlayersList;
