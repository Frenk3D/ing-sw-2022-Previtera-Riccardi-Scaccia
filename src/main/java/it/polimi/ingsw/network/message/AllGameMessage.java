...
public class AllGameMessage extends Message {
    private final List<ReducedPlayer> playersList;
    private final List<ReducedIsland> islandsList;
    private final List<ReducedCloud> cloudsList;
    private final List<ReducedAssistant> assistantsList;
    private final int motherNaturePos;
    private final int tableMoney;
    private final List<ReducedCharacter> charactersList;
