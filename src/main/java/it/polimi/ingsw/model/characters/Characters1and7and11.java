...
public class Characters1and7and11 extends Character {
     ...
     * @param studentIndex the student chosen
     ...
     * @param studentsIndexList         the student indexes of the card
     * @param studentsIndexEntranceList the student indexes of the entrance list
     ...
     *
     * @param cardPlayer   the card player
     * @param studentIndex the student from the card
     ...
     *
     * @param params the character params
